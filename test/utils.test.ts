...
describe('input-helper tests', () => {
  ...
  it('requires error message', async () => {
    ...
    await expect(inputHelper.getInputs()).rejects.toThrow('Input required and not supplied: error');
  });

  it('requires event', async () => {
    inputs.pattern = 'some-pattern';
    inputs.error = 'some-error';
    await expect(inputHelper.getInputs()).rejects.toThrow('Event "undefined" is not supported.');
  });
  ...
  it('requires valid event', async () => {
    ...
    inputs.pattern = 'some-pattern';
    inputs.error = 'some-error';
    await expect(inputHelper.getInputs()).rejects.toThrow('Event "some-event" is not supported.');
  });
  ...
  it('requires pull_request payload', async () => {
    ...
    inputs.pattern = 'some-pattern';
    inputs.error = 'some-error';
    await expect(inputHelper.getInputs()).rejects.toThrow('No payload found in the context.');
  });
  ...
  it('requires pull_request', async () => {
    ...
    inputs.pattern = 'some-pattern';
    inputs.error = 'some-error';
    await expect(inputHelper.getInputs()).rejects.toThrow('No pull_request found in the payload.');
  });
  ...
  it('requires pull_request title', async () => {
    ...
    inputs.pattern = 'some-pattern';
    inputs.error = 'some-error';
    await expect(inputHelper.getInputs()).rejects.toThrow('No title found in the pull_request.');
  });
  ...
  it('requires pull_request number', async () => {
    ...
    await expect(inputHelper.getInputs()).rejects.toThrow('No number found in the pull_request.');
  });
  ...
  it('requires repository', async () => {
    ...
    inputs.checkAllCommitMessages = 'true';
    inputs.accessToken = 'dummy-token';
    await expect(inputHelper.getInputs()).rejects.toThrow('No repository found in the payload.');
  });
  ...
  it('requires repository name', async () => {
    ...
    inputs.checkAllCommitMessages = 'true';
    inputs.accessToken = 'dummy-token';
    await expect(inputHelper.getInputs()).rejects.toThrow('No name found in the repository.');
  });
  ...
  it('requires repository owner (1)', async () => {
    ...
    inputs.checkAllCommitMessages = 'true';
    inputs.accessToken = 'dummy-token';
    await expect(inputHelper.getInputs()).rejects.toThrow('No owner found in the repository.');
  });
