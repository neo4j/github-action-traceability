...
class DummyLinearClient {
    ...
    getIssueAttachmentUrls(identifier) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.authFails) {
                throw new Error('The Linear API rejected the request as unauthorised. Verify the linear_api_key secret is set and has access to the workspace where issues live.');
            }
