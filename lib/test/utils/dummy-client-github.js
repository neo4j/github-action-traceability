...
class GitHubClientBuilder {
    ...
    build() {
        return new DummyGitHubClient(this.url, this.title, this.body, this.author, this.commits, this.comments, this.labels);
    }
}
exports.GitHubClientBuilder = GitHubClientBuilder;
class DummyGitHubClient {
    constructor(url, title, body, author, commits, comments, labels) {
        this.url = url;
        this.title = title;
        this.body = body;
        this.author = author;
